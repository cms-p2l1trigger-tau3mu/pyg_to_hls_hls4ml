...
class GenerateConvInstructions(OptimizerPass):
    ...
    ''' Note, for parallel implementation of CNNs it simply writes placeholder values (to avoid duplicate, largely similar code between io_stream and io_parallel) '''
    def match(self, node):
